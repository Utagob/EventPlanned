...
function show($event, string $from = 'index'){
    ...
    $eventUrl = 'event.php?id=' . (int)$event['id'] . '&from=' . urlencode($from);

    echo '<a class="event-card-link" href="' . $eventUrl . '">';
...
function show_events_by_label(array $events, string $from = 'index') {
    if (empty($events)) {
